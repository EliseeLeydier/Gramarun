...
def ajouter():
    if request.method == 'POST':
        ...
        #Vérifie si la question est trop courte
            ...
            flash('The question is too long, max 60 characters please', category='error')
        elif len(answer1) > 15 or len(answer2) > 15 or len(answer3) > 15 or len(answer4) > 15:
            flash('The answers are too long, max 15 characters please', category='error')
